...
class reports extends Admin_Controller
{
	...
	{
		$this->auth->restrict('Actions.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_actions())
			{
				...
				redirect(SITE_AREA .'/reports/actions');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Actions.Reports.Edit');
		...
		{
			$this->auth->restrict('Actions.Reports.Delete');
