...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Actions.Developer.View');
	...
	{
		$this->auth->restrict('Actions.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_actions())
			{
				...
				redirect(SITE_AREA .'/developer/actions');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Actions.Developer.Edit');
		...
		{
			$this->auth->restrict('Actions.Developer.Delete');
