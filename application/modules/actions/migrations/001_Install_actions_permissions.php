...
class Migration_Install_actions_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Actions.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Settings.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Developer.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Developer.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Developer.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Actions.Developer.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
