...
$num_columns	= 14;
$can_delete	= $this->auth->has_permission('Actions.Developer.Delete');
$can_edit		= $this->auth->has_permission('Actions.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/actions/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->name); ?></td>
				<?php else : ?>
