...
class Migration_Install_action_dependencies_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Action_Dependencies.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Action_Dependencies.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Action_Dependencies.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Action_Dependencies.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
