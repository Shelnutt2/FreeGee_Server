...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('FreeGee.Content.View');
	...
	{
		$this->auth->restrict('FreeGee.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_freegee())
			{
				...
				redirect(SITE_AREA .'/content/freegee');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('FreeGee.Content.Edit');
		...
		{
			$this->auth->restrict('FreeGee.Content.Delete');
