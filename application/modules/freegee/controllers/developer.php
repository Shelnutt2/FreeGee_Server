...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('FreeGee.Developer.View');
	...
	{
		$this->auth->restrict('FreeGee.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_freegee())
			{
				...
				redirect(SITE_AREA .'/developer/freegee');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('FreeGee.Developer.Edit');
		...
		{
			$this->auth->restrict('FreeGee.Developer.Delete');
