...
class Migration_Install_freegee_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'FreeGee.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Developer.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Developer.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Developer.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FreeGee.Developer.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
