...
class Migration_Install_devices_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Devices.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Devices.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Devices.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Devices.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Devices.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Devices.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Devices.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Devices.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
