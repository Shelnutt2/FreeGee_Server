...
$num_columns	= 12;
$can_delete	= $this->auth->has_permission('Devices.Content.Delete');
$can_edit		= $this->auth->has_permission('Devices.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/devices/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->name); ?></td>
				<?php else : ?>
