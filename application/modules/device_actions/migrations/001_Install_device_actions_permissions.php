...
class Migration_Install_device_actions_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Device_Actions.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Device_Actions.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Device_Actions.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Device_Actions.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
